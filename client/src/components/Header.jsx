          ...
          <div className="flex items-center gap-4">
            ...
            {isAdmin && (
              <button
                ...
                className="inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium text-sm transition-colors"
            ...
            <div className="relative">
              ...
              {menuOpen && (
                <>
                  ...
                  <div className="absolute right-0 top-12 z-20 w-48 rounded-lg bg-white border border-gray-200 shadow-xl py-1">

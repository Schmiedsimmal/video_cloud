  ...
  return (
    <div className="flex flex-col items-center justify-center py-24 text-center">
      <div className="relative mb-6">
        ...
        <div className="relative flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br from-gray-100 to-gray-200 border border-gray-300">
          <Film className="w-10 h-10 text-brand-500" />
        </div>
      </div>
      <h2 className="text-2xl font-bold text-gray-900 mb-2">Noch keine Videos</h2>
